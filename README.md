...
JavaScript (JS) — это высокоуровневый, интерпретируемый язык программирования, являющийся третьим ключевым компонентом веб-технологий (наряду с [HTML](https://developer.mozilla.org/ru/docs/Learn_web_development/Core/Scripting/What_is_JavaScript) и CSS). Он используется для создания интерактивных веб-страниц,  анимации, обработки пользовательских действий и работы с контентом на  стороне клиента (в браузере), а также на сервере (Node.js). 
