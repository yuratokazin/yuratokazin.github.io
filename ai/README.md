...
## Занятие 1. Введение в разботку с ИИ. 

### Проект №1: создаем лендинг с помощью ИИ
...
Обзор передовых LLM моделей: OpenAI o3, o4-mini, Claude Sonnet 4, Opus 4, Gemini Pro 2.5, DeepSeek R1
...
### Проект №3: No-code ИИ-агент - Telegram-бот на n8n
...
### Проект №4: Разработка ИИ-агента через код
